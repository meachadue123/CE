...
public class CE
{
    ...
    public void chargeCheck2() throws Exception
    ...
    public void deployCinthas() throws Exception
    {
    ...
    public void useCharge() throws Exception
    {
        Scanner input = new Scanner(System.in);
    ...
    public void overHeat() throws Exception
    {
        print("MAXIMUM",30);
    ...
    public void castAbilities() throws Exception{
    }
    //-----------------------------------------------------------------------------//
